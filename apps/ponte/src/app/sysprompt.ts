...
export const readSystemPrompt = async (config: Config): Promise<string | null> =>
  readPrompt(config.systemPromptFile);

export const setSystemPrompt = async (config: Config, fileOrLiteral: string): Promise<void> => {
